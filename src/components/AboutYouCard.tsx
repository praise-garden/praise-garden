                ...
                <form className="flex w-full flex-col gap-4 text-white">
                  ...
                  {config.props.fields.name.enabled && (
                    ...
                    >
                        ...
                        >
                        {config.props.fields.name.label} <span className="text-red-500">*</span>
                        </label>
                        <input
                        id="name"
                        name="name"
                  ...
                  >
                      {config.props.fields.title.enabled && (
                        <div>
                            ...
                            >
                                {config.props.fields.title.label} <span className="text-red-500">*</span>
                            </label>
                            <input
                                id="title"
                                name="title"
                      ...
                      {config.props.fields.company.enabled && (
                        <div>
                            ...
                            >
                                {config.props.fields.company.label} (optional)
                            </label>
                            <input
                                id="company"
                                name="company"
