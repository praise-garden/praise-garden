      ...
      <div className="flex-1 flex flex-col min-w-0 bg-[#09090b] relative">
        ...
        <div className="h-16 border-b border-zinc-800 flex items-center justify-between px-6 bg-[#09090b]">
          <div className="flex items-center gap-1 bg-zinc-900/50 p-1 rounded-lg border border-zinc-800">
            <button onClick={() => setDevice("desktop")} className={cn("p-2 rounded-md transition-all", device === "desktop" ? "bg-zinc-800 text-white shadow-sm" : "text-zinc-500 hover:text-zinc-300")}>
              <Monitor className="h-4 w-4" />
            </button>
            <button onClick={() => setDevice("tablet")} className={cn("p-2 rounded-md transition-all", device === "tablet" ? "bg-zinc-800 text-white shadow-sm" : "text-zinc-500 hover:text-zinc-300")}>
              <Tablet className="h-4 w-4" />
            </button>
            <button onClick={() => setDevice("mobile")} className={cn("p-2 rounded-md transition-all", device === "mobile" ? "bg-zinc-800 text-white shadow-sm" : "text-zinc-500 hover:text-zinc-300")}>
