...
export default function FormsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50/50 font-sans">
            ...
            <div className="flex items-center justify-between h-16 px-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Create and manage your testimonial forms</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="hidden md:flex items-center gap-2 text-sm text-gray-500">
                  ...
                  <span>/</span>
                  <span className="text-gray-900">Forms</span>
                </div>
              </div>
            </div>
          </header>
            ...
            {isLoading ? (
              <div className="flex items-center justify-center py-20">
                <div className="flex flex-col items-center gap-4">
                  <div className="size-12 border-4 border-purple-200 border-t-purple-600 rounded-full animate-spin"></div>
                    ...
                    >
                      ...
                      <div className={`h-32 ${getGradientClass(index)} relative overflow-hidden`}>
                        ...
                        <div className="absolute top-4 right-4">
                          <Badge 
                            className="bg-emerald-500/90 hover:bg-emerald-500 text-white border-0 backdrop-blur-sm shadow-lg text-xs font-medium px-3 py-1 rounded-full"
                          >
                            Active
                          </Badge>
                        </div>
                        ...
                        <div className="absolute bottom-4 left-4">
                          <div className="size-10 rounded-xl bg-white/20 backdrop-blur-sm border border-white/30 flex items-center justify-center">
                      ...
                      <CardContent className="p-6 space-y-4">
                        ...
                        <div className="space-y-2">
                          <h4 className="text-lg font-semibold text-gray-900 truncate group-hover:text-purple-600 transition-colors">
                            {form.name}
                          </h4>
                        ...
                        <div className="grid grid-cols-2 gap-3 pt-3 border-t border-gray-100">
                          ...
                          <div className="flex items-center gap-2">
                            <div className="size-8 rounded-lg bg-gray-50 flex items-center justify-center">
                              <ClockIcon className="size-3.5 text-gray-600" />
                            </div>
                            <div>
                        ...
                        <div className="flex items-center gap-2 pt-2">
                          <Link href={`/dashboard/form-builder?id=${form.id}`} className="flex-1">
                            <Button 
                              variant="default"
                              className="w-full bg-gray-900 hover:bg-gray-800 text-white rounded-xl font-medium shadow-sm hover:shadow-md transition-all duration-300"
                            >
                          ...
                          <Button 
                            variant="outline"
                            className="px-3 rounded-xl border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-300"
                          >
                            <MoreVerticalIcon />
                          </Button>
                        </div>
              ...
              <div className="flex flex-col items-center justify-center py-20 px-4">
                <div className="size-20 rounded-3xl bg-gradient-to-br from-purple-100 to-violet-100 flex items-center justify-center mb-6">
                  <FileTextIcon className="size-10 text-purple-600" />
                </div>
